...
void Essai1()
{
  ...
  // ...
  catch (const RGBException& ex) 
  {
    cout << "Erreur RGB : " << ex.getMessage() << " avec la valeur : " << ex.getValeur() << endl;
  }
...
void Essai2()
{
  ...
  // ...
  catch(const XYException& ex)
  {
      cout << "Erreur XYException : " << ex.getMessage();
      if (strcmp(ex.getCoordonnee(), "d") == 0){
          cout << " Coordonnees invalides !";
      }else if (strcmp(ex.getCoordonnee(), "x") == 0){
          cout << " Coordonnee X invalide !";
      } else if (strcmp(ex.getCoordonnee(), "y") == 0){
          cout << " Coordonnee Y invalide !";
      }
      cout << endl;
  }
}
...
void Essai3()
{
  ...
  catch(const XYException& ex1)
  {
      cout << "Erreur XYException : " << ex1.getMessage();
      if (strcmp(ex1.getCoordonnee(), "d") == 0){
          cout << " Coordonnees invalides !";
      }else if (strcmp(ex1.getCoordonnee(), "x") == 0){
          cout << " Coordonnee X invalide !";
      } else if (strcmp(ex1.getCoordonnee(), "y") == 0){
          cout << " Coordonnee Y invalide !";
      }
      cout << endl;
  }
